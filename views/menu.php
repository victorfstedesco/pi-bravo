...
<body>
    <main>
        <section>
            ...
            <p class="descricao">Esse aplicativo tem como o intuito acadêmico. Qualquer dúvida entre em contato com os desenvolvedores. Clique aqui <a href="https://www.figma.com/design/R4eTpYzFdn0nOT1yelLDk7/PI---BRAVO?node-id=0-1&t=9WdFYzIDd5RykAte-1" target="_blank"><strong>'figma'</strong></a> para uma visualização geral do design</p>
        </section>
    </main>
</body>
</html>